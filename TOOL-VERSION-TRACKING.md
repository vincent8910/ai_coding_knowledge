...
|---|---|---|---|---|
| Claude Code | v2.1.258 stable | 2026-09-02 Asia/Taipei | [Anthropic v2.1.258](https://github.com/anthropics/claude-code/releases/tag/v2.1.258) · [Claude Code changelog](https://code.claude.com/docs/en/changelog) | stable；官方 release body 可確認修正 macOS 12（Monterey）啟動回歸，以及重送 permission approval 無法套用後造成 remote／scheduled session 空訊息失敗；未在本專案重新執行行為實測，不把版本存在當成行為保證 |
| Gemini CLI | v0.58.0 stable；v0.59.0-preview.0 與 v0.59.0-nightly.20260901.g0bd1d4397 另列觀察 | 2026-09-02 Asia/Taipei | [Gemini v0.58.0](https://github.com/google-gemini/gemini-cli/releases/tag/v0.58.0) · [preview](https://github.com/google-gemini/gemini-cli/releases/tag/v0.59.0-preview.0) · [nightly](https://github.com/google-gemini/gemini-cli/releases/tag/v0.59.0-nightly.20260901.g0bd1d4397) · [release channels](https://github.com/google-gemini/gemini-cli#release-channels) | stable／preview／nightly 分開；stable release note 可確認 symlink ignore path 一致性、macOS Seatbelt 隔離 Docker／container runtime、workspace safety checkers 等變更；preview 另含 MCP OAuth metadata SSRF 防護與 restricted mode fail-closed workspace trust，未納入穩定教學基準 |
| Codex CLI | v0.152.1 stable；v0.153.0-alpha.4 另列觀察 | 2026-09-02 Asia/Taipei | [Codex v0.152.1](https://github.com/openai/codex/releases/tag/rust-v0.152.1) · [alpha](https://github.com/openai/codex/releases/tag/rust-v0.153.0-alpha.4) | stable／alpha 分開；stable release body 可確認 Guardian approval review 現在遵循 model metadata 提供的 Node REPL policy；alpha 只作觀察，不推論永久能力，未在本專案重新執行 workflow 實測 |
