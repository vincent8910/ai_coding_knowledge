...
|---|---|---|---|---|
| Claude Code | v2.1.259 stable | 2026-09-03 Asia/Taipei | [Anthropic v2.1.259](https://github.com/anthropics/claude-code/releases/tag/v2.1.259) · [Claude Code changelog](https://code.claude.com/docs/en/changelog) | stable；官方 release body 可確認新增 managed MCP servers、`--permission-prompts none`、`claude plugin validate --json`，以及並行 session 設定遺失、MCP 啟動斷線誤報、worktree 隔離等修正；未在本專案重新執行行為實測，不把版本存在當成行為保證 |
| Gemini CLI | v0.58.0 stable；v0.59.0-preview.0 與 v0.59.0-nightly.20260902.g4963a4456 另列觀察 | 2026-09-03 Asia/Taipei | [Gemini v0.58.0](https://github.com/google-gemini/gemini-cli/releases/tag/v0.58.0) · [preview](https://github.com/google-gemini/gemini-cli/releases/tag/v0.59.0-preview.0) · [nightly](https://github.com/google-gemini/gemini-cli/releases/tag/v0.59.0-nightly.20260902.g4963a4456) · [release channels](https://github.com/google-gemini/gemini-cli#release-channels) | stable／preview／nightly 分開；stable release note 可確認 symlink ignore path 一致性、macOS Seatbelt 隔離 Docker／container runtime、workspace safety checkers 等變更；nightly 僅新增 web fetch destination validation／connection routing 修正，不納入穩定教學基準 |
| Codex CLI | v0.152.1 stable；v0.153.0-alpha.5.1 另列觀察 | 2026-09-03 Asia/Taipei | [Codex v0.152.1](https://github.com/openai/codex/releases/tag/rust-v0.152.1) · [alpha](https://github.com/openai/codex/releases/tag/rust-v0.153.0-alpha.5.1) | stable／alpha 分開；stable release body 可確認 Guardian approval review 現在遵循 model metadata 提供的 Node REPL policy；alpha.5.1 僅為預覽版 release，未納入穩定教學基準，未在本專案重新執行 workflow 實測 |
