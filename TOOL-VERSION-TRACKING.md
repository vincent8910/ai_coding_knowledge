...
|---|---|---|---|---|
| Claude Code | v2.1.270 stable | 2026-09-13 Asia/Taipei | [Anthropic v2.1.270](https://github.com/anthropics/claude-code/releases/tag/v2.1.270) · [Claude Code changelog](https://code.claude.com/docs/en/changelog) | stable；v2.1.270 修正長時間執行 session 後，唯讀 Git 指令在 Bash 中意外再次要求 permission 的 regression；未在本專案重新執行行為實測，不把版本存在當成行為保證 |
