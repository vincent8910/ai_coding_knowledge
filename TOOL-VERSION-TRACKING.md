...
|---|---|---|---|---|
| Claude Code | v2.1.282 stable | 2026-09-25 Asia/Taipei | [Anthropic v2.1.282](https://github.com/anthropics/claude-code/releases/tag/v2.1.282) · [Claude Code changelog](https://code.claude.com/docs/en/changelog) | stable；GitHub release API 與官方 changelog 查證於 2026-09-25；本版包含 `maxProseWidth`、telemetry 設定可見性、managed MCP／Chrome 相容性與多項 session／permission 修正；未在本專案重新執行行為實測，不把版本存在當成行為保證 |
| Gemini CLI | v0.61.0 stable；v0.62.0-preview.0 與 v0.62.0-nightly.20260924.g8e70c862f 另列觀察 | 2026-09-25 Asia/Taipei | [Gemini v0.61.0](https://github.com/google-gemini/gemini-cli/releases/tag/v0.61.0) · [preview](https://github.com/google-gemini/gemini-cli/releases/tag/v0.62.0-preview.0) · [nightly](https://github.com/google-gemini/gemini-cli/releases/tag/v0.62.0-nightly.20260924.g8e70c862f) · [release channels](https://github.com/google-gemini/gemini-cli#release-channels) | stable／preview／nightly 分開；官方 release notes 可確認 v0.61.0 的間接 prompt-injection 防護、sandbox filesystem boundary hardening 與 runtime state isolation；preview／nightly 僅作觀察，不納入穩定教學基準 |
| Codex CLI | v0.156.1 stable；v0.158.0-alpha.12 另列觀察 | 2026-09-25 Asia/Taipei | [Codex v0.156.1](https://github.com/openai/codex/releases/tag/rust-v0.156.1) · [alpha.12](https://github.com/openai/codex/releases/tag/rust-v0.158.0-alpha.12) | stable／alpha 分開；stable release note 為 GPT-6 Sol／Luna model picker hotfix；alpha 僅作觀察，不納入穩定教學基準；未在本專案重新執行 workflow 實測 |
