...
|---|---|---|---|---|
| Claude Code | v2.1.273 stable | 2026-09-16 Asia/Taipei | [Anthropic v2.1.273](https://github.com/anthropics/claude-code/releases/tag/v2.1.273) · [Claude Code changelog](https://code.claude.com/docs/en/changelog) | stable；官方 release body 列出 MCP 斷線通知／重連終止提示、remote-control session fork，以及 permission checker、managed MCP policy 與 gateway 認證修正；未在本專案重新執行行為實測，不把版本存在當成行為保證 |
| Gemini CLI | v0.60.0 stable；v0.61.0-preview.0 與 v0.61.0-nightly.20260915.g9c1b0a610 另列觀察 | 2026-09-16 Asia/Taipei | [Gemini v0.60.0](https://github.com/google-gemini/gemini-cli/releases/tag/v0.60.0) · [preview](https://github.com/google-gemini/gemini-cli/releases/tag/v0.61.0-preview.0) · [nightly](https://github.com/google-gemini/gemini-cli/releases/tag/v0.61.0-nightly.20260915.g9c1b0a610) · [release channels](https://github.com/google-gemini/gemini-cli#release-channels) | stable／preview／nightly 分開；v0.60.0 release body 可確認 web fetch destination validation、MCP OAuth RFC 9207 issuer 驗證、macOS Seatbelt 暫存目錄隔離與 extension path boundary hardening；preview／nightly 僅作觀察，不納入穩定教學基準 |
| Codex CLI | v0.154.0 stable；v0.155.0-alpha.8 另列觀察 | 2026-09-16 Asia/Taipei | [Codex v0.154.0](https://github.com/openai/codex/releases/tag/rust-v0.154.0) · [alpha.8](https://github.com/openai/codex/releases/tag/rust-v0.155.0-alpha.8) | stable／alpha 分開；stable release body 記錄 experimental `--worktree`／`/worktree`、MCP OAuth refresh coordination，以及 trust 建立前不執行 workspace-controlled helper；alpha 僅作觀察，不納入穩定教學基準；未在本專案重新執行 workflow 實測 |
