...
|---|---|---|---|---|
| Claude Code | v2.1.280 stable | 2026-09-23 Asia/Taipei | [Anthropic v2.1.280](https://github.com/anthropics/claude-code/releases/tag/v2.1.280) · [Claude Code changelog](https://code.claude.com/docs/en/changelog) | stable；GitHub release API 與官方 changelog 查證於 2026-09-23，未在本專案重新執行行為實測，不把版本存在當成行為保證 |
| Gemini CLI | v0.60.0 stable；v0.61.0-preview.0 與 v0.62.0-nightly.20260922.gd5b3e3acc 另列觀察 | 2026-09-23 Asia/Taipei | [Gemini v0.60.0](https://github.com/google-gemini/gemini-cli/releases/tag/v0.60.0) · [preview](https://github.com/google-gemini/gemini-cli/releases/tag/v0.61.0-preview.0) · [nightly](https://github.com/google-gemini/gemini-cli/releases/tag/v0.62.0-nightly.20260922.gd5b3e3acc) · [release channels](https://github.com/google-gemini/gemini-cli#release-channels) | stable／preview／nightly 分開；官方 release notes 可確認 v0.60.0 的 web fetch destination validation、MCP OAuth RFC 9207 issuer 驗證、macOS Seatbelt 暫存目錄隔離與 extension path boundary hardening；preview／nightly 僅作觀察，不納入穩定教學基準 |
| Codex CLI | v0.156.0 stable；v0.157.0-alpha.10 另列觀察 | 2026-09-23 Asia/Taipei | [Codex v0.156.0](https://github.com/openai/codex/releases/tag/rust-v0.156.0) · [alpha.10](https://github.com/openai/codex/releases/tag/rust-v0.157.0-alpha.10) | stable／alpha 分開；版本由 OpenAI Codex GitHub release API 查證；alpha 僅作觀察，不納入穩定教學基準；未在本專案重新執行 workflow 實測 |
