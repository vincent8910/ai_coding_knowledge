...
|---|---|---|---|---|
| Claude Code | v2.1.275 stable | 2026-09-18 Asia/Taipei | [Anthropic v2.1.275](https://github.com/anthropics/claude-code/releases/tag/v2.1.275) · [Claude Code changelog](https://code.claude.com/docs/en/changelog) | stable；官方 release body 列出 claude.ai skills／plugins 同步、gateway 帳號確認、plugin marketplace 安全修正、session transcript／resume 修正與 sandbox／memory 穩定性修正；未在本專案重新執行行為實測，不把版本存在當成行為保證 |
| Gemini CLI | v0.60.0 stable；v0.61.0-preview.0 與 v0.62.0-nightly.20260917.g6a466a7e2 另列觀察 | 2026-09-18 Asia/Taipei | [Gemini v0.60.0](https://github.com/google-gemini/gemini-cli/releases/tag/v0.60.0) · [preview](https://github.com/google-gemini/gemini-cli/releases/tag/v0.61.0-preview.0) · [nightly](https://github.com/google-gemini/gemini-cli/releases/tag/v0.62.0-nightly.20260917.g6a466a7e2) · [release channels](https://github.com/google-gemini/gemini-cli#release-channels) | stable／preview／nightly 分開；v0.60.0 release body 可確認 web fetch destination validation、MCP OAuth RFC 9207 issuer 驗證、macOS Seatbelt 暫存目錄隔離與 extension path boundary hardening；preview／nightly 僅作觀察，不納入穩定教學基準 |
| Codex CLI | v0.155.0 stable；v0.155.0-alpha.18 另列觀察 | 2026-09-18 Asia/Taipei | [Codex v0.155.0](https://github.com/openai/codex/releases/tag/rust-v0.155.0) · [alpha.18](https://github.com/openai/codex/releases/tag/rust-v0.155.0-alpha.18) | stable／alpha 分開；stable release body 記錄 worktree／agent overview、MCP OAuth 失效提示、Touch ID MCP request verification 與 daemon recovery；alpha 僅作觀察，不納入穩定教學基準；未在本專案重新執行 workflow 實測 |
