...
|---|---|---|---|---|
| Claude Code | v2.1.281 stable | 2026-09-24 Asia/Taipei | [Anthropic v2.1.281](https://github.com/anthropics/claude-code/releases/tag/v2.1.281) · [Claude Code changelog](https://code.claude.com/docs/en/changelog) | stable；GitHub release API 與官方 changelog 查證於 2026-09-24；本版包含 MCP 2026-07-28 URL-mode elicitation 與 plugin MCP 設定檢查，未在本專案重新執行行為實測，不把版本存在當成行為保證 |
| Gemini CLI | v0.61.0 stable；v0.62.0-preview.0 與 v0.62.0-nightly.20260923.g62364cb20 另列觀察 | 2026-09-24 Asia/Taipei | [Gemini v0.61.0](https://github.com/google-gemini/gemini-cli/releases/tag/v0.61.0) · [preview](https://github.com/google-gemini/gemini-cli/releases/tag/v0.62.0-preview.0) · [nightly](https://github.com/google-gemini/gemini-cli/releases/tag/v0.62.0-nightly.20260923.g62364cb20) · [release channels](https://github.com/google-gemini/gemini-cli#release-channels) | stable／preview／nightly 分開；官方 release notes 可確認 v0.61.0 的間接 prompt-injection 防護、sandbox filesystem boundary hardening 與 runtime state isolation；preview／nightly 僅作觀察，不納入穩定教學基準 |
| Codex CLI | v0.156.1 stable；v0.158.0-alpha.6 另列觀察 | 2026-09-24 Asia/Taipei | [Codex v0.156.1](https://github.com/openai/codex/releases/tag/rust-v0.156.1) · [alpha.6](https://github.com/openai/codex/releases/tag/rust-v0.158.0-alpha.6) | stable／alpha 分開；stable release note 為 GPT-6 Sol／Luna model picker hotfix；alpha 僅作觀察，不納入穩定教學基準；未在本專案重新執行 workflow 實測 |
