...
|---|---|---|---|---|
| Claude Code | v2.1.278 stable | 2026-09-20 Asia/Taipei | [Anthropic v2.1.278](https://github.com/anthropics/claude-code/releases/tag/v2.1.278) · [Claude Code changelog](https://code.claude.com/docs/en/changelog) | stable；官方 changelog 記錄 Claude API／Enterprise、Bedrock、Vertex、Foundry 與 gateway 的 auto mode 預設改用 server-side classifier，並新增 `/status` 顯示；未在本專案重新執行行為實測，不把版本存在當成行為保證 |
| Gemini CLI | v0.60.0 stable；v0.61.0-preview.0 與 v0.62.0-nightly.20260919.gcfbcaa8df 另列觀察 | 2026-09-20 Asia/Taipei | [Gemini v0.60.0](https://github.com/google-gemini/gemini-cli/releases/tag/v0.60.0) · [preview](https://github.com/google-gemini/gemini-cli/releases/tag/v0.61.0-preview.0) · [nightly](https://github.com/google-gemini/gemini-cli/releases/tag/v0.62.0-nightly.20260919.gcfbcaa8df) · [release channels](https://github.com/google-gemini/gemini-cli#release-channels) | stable／preview／nightly 分開；v0.60.0 release body 可確認 web fetch destination validation、MCP OAuth RFC 9207 issuer 驗證、macOS Seatbelt 暫存目錄隔離與 extension path boundary hardening；preview／nightly 僅作觀察，不納入穩定教學基準 |
| Codex CLI | v0.155.1 stable；v0.156.0-alpha.9 另列觀察 | 2026-09-20 Asia/Taipei | [Codex v0.155.1](https://github.com/openai/codex/releases/tag/rust-v0.155.1) · [alpha.9](https://github.com/openai/codex/releases/tag/rust-v0.156.0-alpha.9) | stable／alpha 分開；stable release body 記錄新 TUI session 預設停用 reasoning summary，以避免不支援的 provider 拒絕請求；alpha 僅作觀察，不納入穩定教學基準；未在本專案重新執行 workflow 實測 |
