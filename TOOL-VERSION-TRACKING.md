...
|---|---|---|---|---|
| Claude Code | v2.1.272 stable | 2026-09-15 Asia/Taipei | [Anthropic v2.1.272](https://github.com/anthropics/claude-code/releases/tag/v2.1.272) · [Claude Code changelog](https://code.claude.com/docs/en/changelog) | stable；官方 release body 僅列 bug fixes and reliability improvements；未在本專案重新執行行為實測，不把版本存在當成行為保證 |
| Gemini CLI | v0.59.0 stable；v0.60.0-preview.0 與 v0.61.0-nightly.20260914.g9c1b0a610 另列觀察 | 2026-09-15 Asia/Taipei | [Gemini v0.59.0](https://github.com/google-gemini/gemini-cli/releases/tag/v0.59.0) · [preview](https://github.com/google-gemini/gemini-cli/releases/tag/v0.60.0-preview.0) · [nightly](https://github.com/google-gemini/gemini-cli/releases/tag/v0.61.0-nightly.20260914.g9c1b0a610) · [release channels](https://github.com/google-gemini/gemini-cli#release-channels) | stable／preview／nightly 分開；v0.59.0 release body 可確認 MCP OAuth metadata SSRF 修正與 restricted mode fail-closed workspace trust；preview／nightly 僅作觀察，不納入穩定教學基準 |
| Codex CLI | v0.154.0 stable；v0.155.0-alpha.5 另列觀察 | 2026-09-15 Asia/Taipei | [Codex v0.154.0](https://github.com/openai/codex/releases/tag/rust-v0.154.0) · [alpha.5](https://github.com/openai/codex/releases/tag/rust-v0.155.0-alpha.5) | stable／alpha 分開；stable release body 記錄 experimental `--worktree`／`/worktree`、MCP OAuth refresh coordination，以及 trust 建立前不執行 workspace-controlled helper；alpha 僅作觀察，未納入穩定教學基準；未在本專案重新執行 workflow 實測 |
